      ...
      <ScrollView style={styles.container}>
        <View style={styles.ratingsContainer}>
          <View style={styles.starOverall}>
            ...
            <Text style={styles.reviewNoText}>
              {reviewNo != 0 ? `${reviewNo} reviews` : "(new shop!)"}
            </Text>
          </View>
        ...
        <ReviewsCard
          ...
          writer={"Tiffany Lo"}
          comments={
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent bibendum nulla nibh"
          }
        />
        <ReviewsCard
          givenStar={5}
        ...
        <ReviewsCard
          ...
          date={"1/10/23"}
          writer={"Tiffany Lo"}
          comments={"At vero eos et accusamus "}
        />
        <Button
          title={"Back to Shop"}
          buttonStyle={{
            backgroundColor: "#EC7632",
            width: "100%",
            borderRadius: 10,
            marginTop: 15,
          }}
          titleStyle={{ fontSize: 16, fontFamily: "Rubik_600SemiBold" }}
          onPress={() =>
            navigation.navigate("ShopOverview", {
              name: shopName,
              shopId: shopId,
